...
echo "<li style='color:#".$weathercolor."'><img src='http://www.google.com/".$icon."' align='left'/>Now - ".$condition." <br /> ".$temp."</li><br /><br />";
}
}
...
echo "<p style='font-size:x-small'>Weather Plugin made by <a href='http://www.xeromi.net'>Web Hosting</a></p>";
}
